...
public class IntroPageTransfer  implements ViewPager.PageTransformer {
        ...
        public void transformPage(View page, float position) {
            ...
            // currently transforming - and thathome_layout_three can be used
            ...
            if (position <= -1.0f || position >= 3.0f) {
             ...
             //   title.setAlpha(1.0f - absPosition);
                ...
                View description = page.findViewById(R.id.iv_cancel_releted_serch);
                //description.setTranslationY(-pageWidthTimesPosition / 3f);
